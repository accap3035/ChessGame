...
*/
static void setupInitialGameBoard(GameBoard gameBoard) {
	// set empty cells
...
Game * gameCreate(int historySize) {
	...
	// set default game board
	setupInitialGameBoard(game->gameBoard);
	
	game->history = piecesArrayCreate(historySize);
...
void gameDestroy(Game * game) {
	...
	piecesArrayDestroy(game->history);
	free(game);
}
...
*/
static bool gameIsSquareEmpty(GameBoard gameBoard, BoardSquare s) {
...
*/
static void getWhitePawnLegalMoves(GameBoard gameBoard,
...
with all the possible moves for the bishop.
Assumes all arguments are valid, and movesBoard contains only false.
*/
static void getWhiteBishopLegalMoves(GameBoard gameBoard,
	bool movesBoard[BOARD_ROWS_NUMBER][BOARD_COLUMNS_NUMBER], BoardSquare s) {
...
with all the possible moves for the rook.
Assumes all arguments are valid, and movesBoard contains only false.
*/
static void getWhiteRookLegalMoves(GameBoard gameBoard,
	bool movesBoard[BOARD_ROWS_NUMBER][BOARD_COLUMNS_NUMBER], BoardSquare s) {
...
with all the possible moves for the knight.
Assumes all arguments are valid, and movesBoard contains only false.
*/
static void getWhiteKnightLegalMoves(GameBoard gameBoard,
	bool movesBoard[BOARD_ROWS_NUMBER][BOARD_COLUMNS_NUMBER], BoardSquare s) {
...
with all the possible moves for the queen.
Assumes all arguments are valid, and movesBoard contains only false.
*/
static void getWhiteQueenLegalMoves(GameBoard gameBoard,
	bool movesBoard[BOARD_ROWS_NUMBER][BOARD_COLUMNS_NUMBER], BoardSquare s) {
	//Since Queen's moves are combination of Bishop and Knight:
...
with all the possible moves for the king.
Assumes all arguments are valid, and movesBoard contains only false.
*/
static void getWhiteKingLegalMoves(GameBoard gameBoard,
	bool movesBoard[BOARD_ROWS_NUMBER][BOARD_COLUMNS_NUMBER], BoardSquare s) {
...
*/
static void getWhitePieceLegalMoves(GameBoard gameBoard,
	bool movesBoard[BOARD_ROWS_NUMBER][BOARD_COLUMNS_NUMBER], BoardSquare s) {
...
*/
static void rotateBoardAndSwitchColors(GameBoard gameBoard) {
	char temp;
...
*/
static BoardSquare getBlackKingSquare(GameBoard gameBoard) {
	BoardSquare s = { -1, -1 };
...
*/
static bool checkBlackKingCheckState(GameBoard gameBoard) {
...
void gameGetLegalMoves(GameBoard gameBoard, bool movesBoard[BOARD_ROWS_NUMBER][BOARD_COLUMNS_NUMBER], BoardSquare s) {
...
void gameForceSetMove(Game * game, BoardSquare from, BoardSquare to) {	
	...
	// add to history
	piecesArrayAddLast(game->history, histElement);
...
static void gameForceUndoPrevMove(Game * game) {
	HistoryElement histElement = piecesArrayGetLast(game->history);
	piecesArrayRemoveLast(game->history);
...
*/
static bool gameIsBlackPieceThreatened(GameBoard gameBoard, BoardSquare s) {
	bool movesBoard[BOARD_ROWS_NUMBER][BOARD_COLUMNS_NUMBER] = { {false} };
...
*/
static bool gameIsPieceThreatened(GameBoard gameBoard, BoardSquare s) {
	bool retValue;
...
GAME_MESSAGE gameUndoPrevMove(Game * game) {
	...
	if (piecesArrayIsEmpty(game->history)) return GAME_UNDO_NO_HISTORY;
